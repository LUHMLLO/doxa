...
<sidebar
  class="none sm:flex column align--center gap--32 w--64p py--16 ml--16 my--16 bord-light bord--solid bord-width--2 theme-radius zindex--12 dpt-secondary bd-blur--8"
